...
export default function App() {
  ...
  // NEW: accept a full Project object, store it, then go to AdvancedEditor
  const handleNewProjectSaved = (project: Project) => {
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-white/70 max-w-2xl mx-auto">
              Piece together stunning dance videos from small choreography clips.
              Create, edit, and perfect your routines with ease.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 pt-16">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 space-y-3">
              ...
              <h3 className="text-xl text-white">Clip & Combine</h3>
              <p className="text-white/60">
                Break down your choreography into manageable pieces and seamlessly
                combine them.
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 space-y-3">
              ...
              <h3 className="text-xl text-white">Video Editor</h3>
              <p className="text-white/60">
                Professional editing tools designed specifically for dance and
                choreography.
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 space-y-3">
              ...
              <h3 className="text-xl text-white">Polish & Perfect</h3>
              <p className="text-white/60">
                Fine-tune transitions, timing, and effects to create stunning final
                products.
              </p>
            </div>
          </div>
